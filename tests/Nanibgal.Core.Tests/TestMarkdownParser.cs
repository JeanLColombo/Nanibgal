...
public class TestMarkdownParser
{
    ...
    public static TheoryData<string, IMarkdownBlock[]> MultipleBlocksData
    {
        get
        {
            var data = new TheoryData<string, IMarkdownBlock[]>();

            data.Add("# Heading 1\n\nThis is a paragraph.", new IMarkdownBlock[] {
                new HeadingBlock(1, "Heading 1"),
                new ParagraphBlock("This is a paragraph.")
            });

            data.Add("## Heading 2\n\nThis is another paragraph.", new IMarkdownBlock[] {
                new HeadingBlock(2, "Heading 2"),
                new ParagraphBlock("This is another paragraph.")
            });

            data.Add("Paragraph 1\n\nParagraph 2", new IMarkdownBlock[] {
                new ParagraphBlock("Paragraph 1"),
                new ParagraphBlock("Paragraph 2")
            });

            data.Add("# Heading 1\n\n## Heading 2\n\n### Heading 3", new IMarkdownBlock[] {
                new HeadingBlock(1, "Heading 1"),
                new HeadingBlock(2, "Heading 2"),
                new HeadingBlock(3, "Heading 3")
            });

            data.Add("Paragraph with\nmultiple\nlines", new IMarkdownBlock[] {
                new ParagraphBlock("Paragraph with\nmultiple\nlines")
            });
            data.Add("this\nis something\n# new\nI tell you", new IMarkdownBlock[] {
    ...
    public void Parse_ShouldReturnExpectedBlocks(string source, IMarkdownBlock[] expectedBlocks)
    {
            var parser = new MarkdownParser();
